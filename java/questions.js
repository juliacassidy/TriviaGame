const quizQuestions = [
    { //1
        question: "This franchise played in Cleveland, Los Angeles, and St. Louis. Which team is this?",
        choices: ["Rams", "Chargers", "Browns", "Vikings"],
        correctAnswer: "Rams"
    },
    { //2
    ...
    { //3
        question: "In what city did the Washington Redskins originally play?",
        choices: ["New York", "Los Angeles", "Tampa", "Boston"],
    ...
    { //5
        ...
        choices: ["Buffalo Bills", "Chicago Bears", "Tennessee Titans", "Oakland Raiders"],
    ...
    { //8
        question: "Which team was wide reciever Antonio Brown recently traded to, after spending 8 seasons with the Pittsburgh Steelers?",
        choices: ["Oakland Raiders", "Buffalo Bills", "New York Jets", "Los Angeles Chargers"],
